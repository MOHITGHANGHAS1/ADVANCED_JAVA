// QUE.= you have to us a atree set to insert the valuee withe the secified  
//key 1 2 3 4 5 with 5 value 1 . algoritham 2. logic 3 . implementation 3 chatgpt 
//5, machine learning 1. covert in descending value
//find value which are greater than 4 ,
//,value which are between 2 and 5
//inend replace the value the vale of chatgpt with myownbrain with replace
package Maps;
import java.util.*;
public class Map_que1 {
